...
const mockMessages = [
  {
    ...
    content:
      "Hello Dr. Sharma, I need help with my CNN architecture for image classification.",
    timestamp: new Date(Date.now() - 3600000).toISOString(),
    read: true,
  },
  {
    ...
    senderAvatar: "/placeholder.svg?height=40&width=40",
    content:
      "Hi Vikram, I'd be happy to help. What specific issue are you facing with the CNN architecture?",
  ...
  },
  {
    ...
    senderAvatar: "/placeholder.svg?height=40&width=40",
    content:
      "That makes sense. What about the kernel size for the convolutional layers?",
  ...
  },
  {
    ...
    senderAvatar: "/placeholder.svg?height=40&width=40",
    content:
      "Also, should I use batch normalization after each convolutional layer?",

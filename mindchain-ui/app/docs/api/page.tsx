  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg mb-8">
        ...
        <p className="mb-4">
          The MindChain API provides programmatic access to the MindChain
          platform, allowing developers to integrate with and extend the
          functionality of the system. This RESTful API follows standard HTTP
          conventions and uses JSON for data exchange.
        </p>
        <p>
          The complete OpenAPI specification is available in the{" "}
          <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">
            openapi.yaml
          </code>{" "}
          file, which can be imported into API tools like Swagger UI, Postman,
          or Insomnia for interactive exploration.
        </p>
      </div>

      <h2 className="text-2xl font-bold mb-4">Authentication</h2>
      <p className="mb-4">
        The API uses JWT (JSON Web Tokens) for authentication. To access
        protected endpoints, you must include the JWT token in the Authorization
        header:
      </p>
      ...
      <p className="mb-4">
        All responses are returned in JSON format. Successful responses
        typically include the requested data, while error responses include an
        error code, message, and sometimes additional details.
      </p>
  ...
  "details": {
    ...
    "error": "Must be a valid email address"
      ...
      <p className="mb-4">
        ...
        query parameters. Responses include pagination metadata:
      </p>
      <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg overflow-x-auto mb-6">
        <code>{`{
  "data": [...],
...
X-RateLimit-Reset: 1623766800`}</code>
      ...
      <p className="mb-6">
        ...
        When new versions are released, the previous versions will remain
        available for a deprecation period.
      </p>
      ...
      <ul className="list-disc list-inside mb-6 space-y-2">
        <li>
          Import into <strong>Swagger UI</strong> for interactive documentation
        </li>
        <li>
          Import into <strong>Postman</strong> or <strong>Insomnia</strong> to
          create a collection of requests
        </li>
        <li>
          Use with code generators to create client libraries in various
      ...
      <div className="bg-yellow-50 dark:bg-yellow-900/20 p-6 rounded-lg mb-8">
        ...
        <p>
          ...
          contact the MindChain development team at{" "}
          <a
            href="mailto:api-support@mindchain.iiit.ac.in"
            className="text-blue-600 dark:text-blue-400 hover:underline"
          >
            api-support@mindchain.iiit.ac.in
          </a>
          .
        </p>
      </div>
